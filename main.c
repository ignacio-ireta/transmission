...
int main(int argn, char **argv){
  ...
  */
  ...
  a2 = new_People(18, 1, 0, 0.0, 1.0, 3.0, 1.0, 1.0);
  a3 = new_People(18, 1, 0, 0.0, 2.0, 5.0, 2.0, 4.0);
  a4 = new_People(18, 1, 0, 0.0, 4.0, 6.0, 3.0, 1.0);
  a5 = new_People(18, 1, 0, 0.0, 6.0, 8.0, 2.0, 4.0);
